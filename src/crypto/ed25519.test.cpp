...
TEST_CASE("Ed25519 wrong key fails verification", "[ed25519]") {
  const auto kp1 = ed25519Generate();
  const auto kp2 = ed25519Generate();
  const auto sig = ed25519Sign(kp1.priv, {1, 2, 3});
